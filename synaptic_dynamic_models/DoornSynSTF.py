...
class DoornSTF_model(SynDynModel):
    ...
    def get_output_state_variables(self):
        ...
        return np.stack([self.s_ampa, self.s_nmda, self.x_nmda, self.x_d, self.u_d])
    ...
    def get_state_variables_spike_events(self):
        ...
        return {'s_ampa': self.s_ampa_spike_events, 's_nmda': self.s_nmda_spike_events,
                'x_nmda': self.x_nmda_spike_events, 'xd': self.x_d_spike_events, 'ud': self.u_d_spike_events}
